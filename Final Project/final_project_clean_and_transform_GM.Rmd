...
better weight ranges: https://citydogslife.com/small-medium-large-dog-size-guide/

calculate the average based on the range? 
then use that to see if the avg falls in a weight size for to classify
