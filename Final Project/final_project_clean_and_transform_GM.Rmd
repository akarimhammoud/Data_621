...
After making this visualization, it will be best to remove the variables `hypoallergenic` and `size` created earlier as a great amount of observations are `NA` as well as `VideoAmt` and `ColorName3`.


#### Correlation Plot

<This should be after removing the variables with a lot of NA>
```{r}
