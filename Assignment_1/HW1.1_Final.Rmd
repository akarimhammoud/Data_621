...
write.csv(train_full, here('data','hw1_train_data.csv'))
write.csv(evaluation, here('data','hw1_evaluation_data.csv'))
```
...
write.csv(backward_model_predictions_evaluation, here('data','evaluation_predictions.csv'))
