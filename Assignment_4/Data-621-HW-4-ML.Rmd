...
```{r}
#residual sum of squares
RSS <- c(crossprod(wls.step.model$residuals))

#mean squared error
MSE <- RSS / length(wls.step.model$residuals)
...
Using the RMSE as out selection metric, of the three models produced above, we find that the best of the three is the Stepwise Regression Model based on the RMSE.
...
predictions <- predict(step.model, df_eval_mrm)
summary(predictions)
```
